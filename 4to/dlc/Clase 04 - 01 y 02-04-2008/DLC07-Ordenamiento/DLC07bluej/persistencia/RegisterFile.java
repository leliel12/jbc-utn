...
public class RegisterFile < E extends Grabable >
{
    ...
    /**
     * Ubica el puntero de registro activo en la posición de inicio del Register número r. 
     * @param r número del Registro (no el número de byte) que se quiere acceder, contando desde el principio del archivo.
     */
    public void seekRegister(long r)
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Error al posicionar en el registro número " + r + ": " + e.getMessage());    
            System.exit(1);
        }
    }
    ...
    /**
     * Devuelve el número relativo de registro en el cual está posicionado el archivo en este momento.
     * @return el número de registro de posicionamiento actual.
     */
    public long registerPos () 
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Error al intentar devolver el número de registro: " + e.getMessage());   
            System.exit(1);
        }
    ...
    /**
     * Busca un registro en el archivo mediante búsqueda binaria. El archivo se supone ordenado de acuerdo a las 
     * convenciones de compareTo(), y efectúa la búsqueda de acuerdo al mismo método de comparación. Retorna -1 
     * si el registro no se encuentra, o el número de byte donde comienza la primera ocurrencia del registro en disco 
     * si se encontraba en el archivo. En general, el retorno de -1 significa que el registro no fue encontrado, por 
     * cualquier causa. El file pointer sale apuntando al mismo byte donde estaba cuando empezó la operación.
     * @param obj el objeto a buscar en el archivo.
     * @return la posición de byte de la primera ocurrencia del registro en el archivo, si existe, o -1 si no existe.
     */
    ...
    public boolean append (E obj)
    {
       ...
       * algoritmo de Selección Directa. El archivo sale cerrado.
       */
      public void selectionSort ()
      {
        try
        {
            // tenemos que asegurarnos que el archivo esté abierto en modo rw.
            close();
        ...
        {
            JOptionPane.showMessageDialog(null, "Error al ordenar con Selección Directa: " + e.getMessage());   
            System.exit(1);
        }
      }
