...
public class Principal03
{
    public static void main (String args[])
    {
       ...
       int i;
       System.out.println("1. Se graban algunos números enteros en el archivo...");
       try
       {    
           ...
           /* 
            * llevar el puntero al final... elimine el comentario de la instrucción si quiere 
            * que el archivo adquiera nuevos datos en cada ejecución 
            */
           // f.seek( f.length() ); 
           // f.setLength(0);
        ...
        System.out.println("2. Se lee el archivo calculando el número de datos...");
        try
        {   
            // abrir el archivo para leer y grabar
            f  = new  RandomAccessFile(fd, "r");

            // se calcula cuántos int contiene el archivo...
            // ...suponiendo que sabemos que sólo se grabaron valores int...
            long n = f.length() / 4;
