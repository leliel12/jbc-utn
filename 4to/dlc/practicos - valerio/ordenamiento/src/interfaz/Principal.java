...
public class Principal
{
        ...
        /**
         * Muestra el contenido del archivo (s�lo los registros que no est�n marcados como borrados) en consola estandar
         */
       ...
       public static void main (String[] args)
       {
            ...
            do
            {
                ...
                System.out.println ("2. Baja de un registro de Alumno (l�gica)");
                System.out.println ("3. Ordenamiento del archivo");
                System.out.println ("4. B�squeda binaria");
